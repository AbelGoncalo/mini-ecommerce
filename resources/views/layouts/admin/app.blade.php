    ...
    <div class="dashboard-main-wrapper">
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" style="color: #000;" href="{{route('panel.admin.home')}}">
                    MINISHOP
                </a>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link {{(Route::Current()->getName() == 'panel.admin.home') ? 'active':''}}"
                                href="{{route('panel.admin.home')}}">
                                <i class="fa fa-chart-pie"></i>
                                Dashboard</a>
                        </li>

                        <li class="nav-item ">
                            <a class="nav-link {{(Route::Current()->getName() == 'panel.admin.categories') ? 'active':''}} "
                                href="{{route('panel.admin.categories')}}">
                                <i class="fa fa-box"></i>
                                Categorias</a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link {{(Route::Current()->getName() == 'panel.admin.items') ? 'active':''}}"
                                href="{{route('panel.admin.items')}}">
                                <i class="fa fa-tag"></i>
                                Items</a>
                        </li>
                        ...
                        <li class="nav-item ">
                            <a class="nav-link {{(Route::Current()->getName() == 'panel.admin.orders') ? 'active':''}}"
                                href="{{route('panel.admin.orders')}}">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link {{(Route::Current()->getName() == 'panel.admin.user') ? 'active':''}}"
                                href="{{route('panel.admin.user')}}">
                                <i class="fa  fa-users"></i>
                                Utilizadores</a>
                        </li>

                        <li class="nav-item ">
                            <a class="nav-link {{(Route::Current()->getName() == 'panel.admin.customers') ? 'active':''}} "
                                href="{{route('panel.admin.customers')}}">
                                <i class="fa fa-users"></i>
                                Clientes</a>
                        </li>
